...
def video_to_images(vid_file, img_folder=None, return_info=False):
    ...
    # command = ['ffmpeg', # Original command given by VIBE authors
    #            '-i', vid_file,
    #            '-f', 'image2',
    #            '-v', 'error',
    #            f'{img_folder}/%06d.png']

    command = ['ffmpeg', # Copied from TCMR to be consistent with other methods
               '-i', vid_file,
               '-r', '30000/1001',
               '-f', 'image2',
               '-v', 'error',
...
def images_to_video(img_folder, output_vid_file):
    ...
    # command = [ # Original command given by VIBE authors
    ...
    # ]
    command = [ # Copied from TCMR to be consistent with other methods
